...
public partial class popupForgetReg : System.Web.UI.Page
{
    ...
    protected void btnGetOtp_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        OleDbCommand cmd = new OleDbCommand("select count (*) from mst_store where semail = '"+ txtEmail.Text+"'", con);
        ...
        {
            Response.Write("<script>alert('Please Enter Registerd Email')</script>");
        }
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
            con = new OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0;Data Source=E:/pro_pm-20190718T150056Z-001/pro_pm/dbtest.mdb");
            con.Open();
            OleDbCommand cmd = new OleDbCommand("UPDATE mst_store SET spwd = '" + txtNewPwd.Text + "'WHERE semail='" + txtEmail.Text + "'", con);
