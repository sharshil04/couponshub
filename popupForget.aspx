<%@ Page Language="C#" AutoEventWireup="true" CodeFile="popupForget.aspx.cs" Inherits="popupForget" %>
    ...
    <form id="form1" runat="server">
     ...
     <asp:Panel ID="regMob" runat="server" >
        ...
        <asp:Panel ID="verification" runat="server" Visible="false">
            ...
            <tr>
                <td align="center">
                    <asp:Button ID="btnVerify" runat="server" Text="Verify" OnClick="btnVerify_Click" class="btn btn-success" />
